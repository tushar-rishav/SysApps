...
class DirList(object):
    ...
    def __init__(self,initdir=None):
        ...
        self.ls=Button(self.bfm,text='List Dir', command=self.doLS,activeforeground='white',activebackground='green')
    ...
    def doLS(self,ev=None):
        ...
        if not os.path.exists(tdir):
            error=tdir+':Hold on fucker! no such file exists!'
        elif not os.path.isdir(tdir):
            error=tdir+":Dumbass! not a directory!!"
        ...
        if error:
            ...
            self.top.update()
            return
        self.cwd.set('Wait fucker! FETCHING YOUR DIR CONTENTS...')
        self.top.update()
